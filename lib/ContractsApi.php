...
class ContractsApi
{
     ...
     */
    public function transferContractOwnership($contract_id, $x_authorization, $x_password, $transfer_contract_ownership_request)
    {
        list($response) = $this->transferContractOwnershipWithHttpInfo($contract_id, $x_authorization, $x_password, $transfer_contract_ownership_request);
        return $response;
    }
     ...
     */
    public function transferContractOwnershipWithHttpInfo($contract_id, $x_authorization, $x_password, $transfer_contract_ownership_request)
    {
        $request = $this->transferContractOwnershipRequest($contract_id, $x_authorization, $x_password, $transfer_contract_ownership_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function transferContractOwnershipAsync($contract_id, $x_authorization, $x_password, $transfer_contract_ownership_request)
    {
        return $this->transferContractOwnershipAsyncWithHttpInfo($contract_id, $x_authorization, $x_password, $transfer_contract_ownership_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function transferContractOwnershipAsyncWithHttpInfo($contract_id, $x_authorization, $x_password, $transfer_contract_ownership_request)
    {
        $returnType = '\MetaFab\Model\TransactionModel';
        $request = $this->transferContractOwnershipRequest($contract_id, $x_authorization, $x_password, $transfer_contract_ownership_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function transferContractOwnershipRequest($contract_id, $x_authorization, $x_password, $transfer_contract_ownership_request)
    {
        ...
        if ($x_password === null || (is_array($x_password) && count($x_password) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_password when calling transferContractOwnership'
            );
        }
     ...
     * @return \MetaFab\Model\TransactionModel|string|string
     */
    public function upgradeContractTrustedForwarder($contract_id, $x_authorization, $x_password, $upgrade_contract_trusted_forwarder_request)
    {
        list($response) = $this->upgradeContractTrustedForwarderWithHttpInfo($contract_id, $x_authorization, $x_password, $upgrade_contract_trusted_forwarder_request);
        return $response;
    }
     ...
     * @return array of \MetaFab\Model\TransactionModel|string|string, HTTP status code, HTTP response headers (array of strings)
     */
    public function upgradeContractTrustedForwarderWithHttpInfo($contract_id, $x_authorization, $x_password, $upgrade_contract_trusted_forwarder_request)
    {
        $request = $this->upgradeContractTrustedForwarderRequest($contract_id, $x_authorization, $x_password, $upgrade_contract_trusted_forwarder_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function upgradeContractTrustedForwarderAsync($contract_id, $x_authorization, $x_password, $upgrade_contract_trusted_forwarder_request)
    {
        return $this->upgradeContractTrustedForwarderAsyncWithHttpInfo($contract_id, $x_authorization, $x_password, $upgrade_contract_trusted_forwarder_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function upgradeContractTrustedForwarderAsyncWithHttpInfo($contract_id, $x_authorization, $x_password, $upgrade_contract_trusted_forwarder_request)
    {
        $returnType = '\MetaFab\Model\TransactionModel';
        $request = $this->upgradeContractTrustedForwarderRequest($contract_id, $x_authorization, $x_password, $upgrade_contract_trusted_forwarder_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function upgradeContractTrustedForwarderRequest($contract_id, $x_authorization, $x_password, $upgrade_contract_trusted_forwarder_request)
    {
        ...
        if ($x_password === null || (is_array($x_password) && count($x_password) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_password when calling upgradeContractTrustedForwarder'
            );
        }
