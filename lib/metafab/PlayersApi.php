...
class PlayersApi
{
     ...
     * @return \OpenAPI\Client\Model\AuthPlayer200Response|string|string
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\AuthPlayer200Response|string|string, HTTP status code, HTTP response headers (array of strings)
     */
    public function authPlayerWithHttpInfo($x_game_key)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\AuthPlayer200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\AuthPlayer200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\AuthPlayer200Response', []),
            ...
            $returnType = '\OpenAPI\Client\Model\AuthPlayer200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\AuthPlayer200Response',
     ...
     *
     * @param  string $x_game_key The &#x60;publishedKey&#x60; of a specific game. This can be shared or included in game clients, websites, etc. (required)
     * @param  \OpenAPI\Client\Model\CreatePlayerRequest $create_player_request create_player_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\AuthPlayer200Response|string|string
     ...
     *
     * @param  string $x_game_key The &#x60;publishedKey&#x60; of a specific game. This can be shared or included in game clients, websites, etc. (required)
     * @param  \OpenAPI\Client\Model\CreatePlayerRequest $create_player_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\AuthPlayer200Response|string|string, HTTP status code, HTTP response headers (array of strings)
     ...
     * @param  \OpenAPI\Client\Model\UpdatePlayerRequest $update_player_request update_player_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\PlayerModel|string|string
     */
     ...
     * @param  string $player_id Any player id within the MetaFab ecosystem. (required)
     * @param  string $x_authorization The &#x60;accessToken&#x60; of the authenticating player. (required)
     * @param  \OpenAPI\Client\Model\UpdatePlayerRequest $update_player_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\PlayerModel|string|string, HTTP status code, HTTP response headers (array of strings)
     */
    public function updatePlayerWithHttpInfo($player_id, $x_authorization, $update_player_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\PlayerModel' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\PlayerModel' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\PlayerModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\PlayerModel';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\PlayerModel',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
