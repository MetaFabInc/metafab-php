...
class BatchMintCollectionItemsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets item_ids
     *
     * @param int[] $item_ids An array of unique itemIds to create (mint).
     *
     * @return self
     */
     ...
     * Sets quantities
     *
     * @param int[] $quantities An array of the quantities of each of the unique itemIds provided to create (mint). The quantity of each itemId in itemIds should be at the same index as the specific itemId in the itemIds array. For example, quantities[2] defines the quantity to mint for itemIds[2], etc.
     *
     * @return self
     */
