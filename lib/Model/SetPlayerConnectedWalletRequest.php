...
/**
 * SetPlayerConnectedWalletRequest Class Doc Comment
 *
 * @category Class
 * @package  MetaFab
 * @author   OpenAPI Generator team
 ...
 */
class SetPlayerConnectedWalletRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'setPlayerConnectedWallet_request';
    ...
    */
     ...
     * Sets address
     *
     * @param string $address The address of the external wallet to connect to the player.
     *
     * @return self
     */
     ...
     * Sets signature
     *
     * @param string $signature A signature string generated by signing a keccak256 hash generated with abiCoder encode arguments of `[ 'bytes32', 'address', 'bool', 'address', 'uint256' ]` and `[ keccak256(gameId), delegate wallet approved (player's custodial wallet address), true, external wallet address, any unused nonce number ]`.
     *
     * @return self
     */
     ...
     * Sets chain
     *
     * @param string $chain The blockchain you want to support this wallet connection on. If you need to support multiple blockchains, make multiple requests using different `chain` arguments. Support for new blockchains are added over time.
     *
     * @return self
     */
