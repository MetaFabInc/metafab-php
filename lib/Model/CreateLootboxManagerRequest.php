...
/**
 * CreateLootboxManagerRequest Class Doc Comment
 *
 * @category Class
 * @package  MetaFab
 * @author   OpenAPI Generator team
 ...
 */
class CreateLootboxManagerRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createLootboxManager_request';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name of this item collection. This can be anything, such as `Production - Lootbox Manager`, `Testing - My Game Lootbox Manager`, etc.
     *
     * @return self
     */
     ...
     * Sets chain
     *
     * @param string $chain The blockchain you want to deploy this lootbox manager on. Support for new blockchains are added over time.
     *
     * @return self
     */
