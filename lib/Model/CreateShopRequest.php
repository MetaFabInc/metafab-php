...
class CreateShopRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createShop_request';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name of this item collection. This can be anything, such as `Production - Game Shop`, `Testing - My Game Shop`, etc.
     *
     * @return self
     */
     ...
     * Sets chain
     *
     * @param string $chain The blockchain you want to deploy this shop on. Support for new blockchains are added over time.
     *
     * @return self
     */
