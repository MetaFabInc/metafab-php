...
/**
 * ApproveEcosystemGameRequest Class Doc Comment
 *
 * @category Class
 * @package  MetaFab
 * @author   OpenAPI Generator team
 ...
 */
class ApproveEcosystemGameRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'approveEcosystemGame_request';
    ...
    */
     ...
     * Sets game_id
     *
     * @param string $game_id The id of the game being approved.
     *
     * @return self
     */
