...
/**
 * GetCurrencyFees200Response Class Doc Comment
 *
 * @category Class
 * @package  MetaFab
 * @author   OpenAPI Generator team
 ...
 */
class GetCurrencyFees200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getCurrencyFees_200_response';
    ...
    */
     ...
     *
     * @param string|null $recipient_address The wallet address that fees from all applicable transactions are automatically sent to.
     *
     * @return self
     */
     ...
     * Sets basis_points
     *
     * @param float|null $basis_points The number of fee basis points. 100 basisPoints = 1% fee of the total transaction amount deducted from the total received by the recipient.
     *
     * @return self
     */
     ...
     * Sets fixed_amount
     *
     * @param float|null $fixed_amount The fixed number of currency as a fee regardless of the total transaction amount. 10 = 10 of the currency as a fee for any transaction, deducted from the total received by the recipient.
     *
     * @return self
     */
     ...
     * Sets cap_amount
     *
     * @param float|null $cap_amount The maximum combined fee between basisPoints and fixedAmount. If the total transaction fee is over this amount, the capAmount will be used as the transaction fee deducted from the total received by the recipient.
     *
     * @return self
     */
