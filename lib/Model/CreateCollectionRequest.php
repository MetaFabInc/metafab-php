...
class CreateCollectionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createCollection_request';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name of this item collection. This can be anything, such as `Production - Item Collection`, `Testing - My Game Item Collection`, etc.
     *
     * @return self
     */
     ...
     * Sets chain
     *
     * @param string $chain The blockchain you want to deploy this item collection on. Support for new blockchains are added over time.
     *
     * @return self
     */
