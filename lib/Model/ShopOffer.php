 ...
 */
class ShopOffer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShopOffer';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The id of this offer.
     *
     * @return self
     */
     ...
     *
     * @param string|null $input_collection The address of the ERC1155 or MetaFab game items contract for input items required by this offer.
     *
     * @return self
     */
     ...
     *
     * @param int[]|null $input_collection_item_ids An array of item ids from the input collection that are required for this offer.
     *
     * @return self
     */
     ...
     *
     * @param int[]|null $input_collection_item_amounts An array of amounts for each item id for the input collection that are required to use this offer.
     *
     * @return self
     */
     ...
     *
     * @param string|null $output_collection The address of the ERC1155 or MetaFab game items contract for output items given by this offer.
     *
     * @return self
     */
     ...
     *
     * @param int[]|null $output_collection_item_ids An array of item ids from the output collection that are given for this offer.
     *
     * @return self
     */
     ...
     *
     * @param int[]|null $output_collection_item_amounts An array of amounts for each item id for the output collection that are given by this offer.
     *
     * @return self
     */
     ...
     * Sets uses
     *
     * @param int|null $uses The number of times this offer has been used.
     *
     * @return self
     */
     ...
     * Sets max_uses
     *
     * @param int|null $max_uses The maximum number of times this offer can be used. A value of `0` means there is no limit on how many times this offer can be used.
     *
     * @return self
     */
