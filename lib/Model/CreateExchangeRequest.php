...
/**
 * CreateExchangeRequest Class Doc Comment
 *
 * @category Class
 * @package  MetaFab
 * @author   OpenAPI Generator team
 ...
 */
class CreateExchangeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createExchange_request';
    ...
    */
     ...
     * Sets chain
     *
     * @param string $chain The blockchain you want to deploy this exchange on. Support for new blockchains are added over time.
     *
     * @return self
     */
