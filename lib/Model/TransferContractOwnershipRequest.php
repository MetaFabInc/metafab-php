...
/**
 * TransferContractOwnershipRequest Class Doc Comment
 *
 * @category Class
 * @package  MetaFab
 * @author   OpenAPI Generator team
 ...
 */
class TransferContractOwnershipRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'transferContractOwnership_request';
    ...
    */
     ...
     * Sets owner_address
     *
     * @param string $owner_address A wallet address to assign as the new owner and administrator of the target smart contract.
     *
     * @return self
     */
