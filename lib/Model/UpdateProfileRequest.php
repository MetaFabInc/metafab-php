...
class UpdateProfileRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $current_password The profile's current password. Must be provided if setting `newPassword`.
     *
     * @return self
     */
     ...
     * Sets new_password
     *
     * @param string|null $new_password A new password. The profile's old password will no longer be valid.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $reset_access_token Revokes the profile's previous access token and returns a new one if true.
     *
     * @return self
     */
