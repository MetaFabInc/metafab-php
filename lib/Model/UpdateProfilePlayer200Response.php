...
/**
 * UpdateProfilePlayer200Response Class Doc Comment
 *
 * @category Class
 * @package  MetaFab
 * @author   OpenAPI Generator team
 ...
 */
class UpdateProfilePlayer200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateProfilePlayer_200_response';
    ...
    protected static $setters = [
        ...
        'profile_permissions' => 'setProfilePermissions',
    ...
    protected static $getters = [
        ...
        'profile_permissions' => 'getProfilePermissions',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('profile_permissions', $data ?? [], null);
    ...
    */
     ...
     * Sets profile_id
     *
     * @param string|null $profile_id This field has not had a description added.
     *
     * @return self
     */
    ...
    /**
     * Gets profile_permissions
     *
     * @return object|null
     */
    public function getProfilePermissions()
    {
        return $this->container['profile_permissions'];
    }

    /**
     * Sets profile_permissions
     *
     * @param object|null $profile_permissions This field has not had a description added.
     *
     * @return self
     */
    public function setProfilePermissions($profile_permissions)
    {

        if (is_null($profile_permissions)) {
            throw new \InvalidArgumentException('non-nullable profile_permissions cannot be null');
        }

        $this->container['profile_permissions'] = $profile_permissions;
