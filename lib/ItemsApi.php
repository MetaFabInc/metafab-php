...
class ItemsApi
{
     ...
     * @return bool|string
     */
    public function getCollectionRole($collection_id, $role, $address = null, $wallet_id = null)
    {
        list($response) = $this->getCollectionRoleWithHttpInfo($collection_id, $role, $address, $wallet_id);
        return $response;
    }
     ...
     * @return array of bool|string, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCollectionRoleWithHttpInfo($collection_id, $role, $address = null, $wallet_id = null)
    {
        $request = $this->getCollectionRoleRequest($collection_id, $role, $address, $wallet_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCollectionRoleAsync($collection_id, $role, $address = null, $wallet_id = null)
    {
        return $this->getCollectionRoleAsyncWithHttpInfo($collection_id, $role, $address, $wallet_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCollectionRoleAsyncWithHttpInfo($collection_id, $role, $address = null, $wallet_id = null)
    {
        $returnType = 'bool';
        $request = $this->getCollectionRoleRequest($collection_id, $role, $address, $wallet_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCollectionRoleRequest($collection_id, $role, $address = null, $wallet_id = null)
    {
     ...
     * @return \MetaFab\Model\TransactionModel|string|string
     */
    public function grantCollectionRole($collection_id, $x_authorization, $x_password, $grant_collection_role_request)
    {
        list($response) = $this->grantCollectionRoleWithHttpInfo($collection_id, $x_authorization, $x_password, $grant_collection_role_request);
        return $response;
    }
     ...
     * @return array of \MetaFab\Model\TransactionModel|string|string, HTTP status code, HTTP response headers (array of strings)
     */
    public function grantCollectionRoleWithHttpInfo($collection_id, $x_authorization, $x_password, $grant_collection_role_request)
    {
        $request = $this->grantCollectionRoleRequest($collection_id, $x_authorization, $x_password, $grant_collection_role_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function grantCollectionRoleAsync($collection_id, $x_authorization, $x_password, $grant_collection_role_request)
    {
        return $this->grantCollectionRoleAsyncWithHttpInfo($collection_id, $x_authorization, $x_password, $grant_collection_role_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function grantCollectionRoleAsyncWithHttpInfo($collection_id, $x_authorization, $x_password, $grant_collection_role_request)
    {
        $returnType = '\MetaFab\Model\TransactionModel';
        $request = $this->grantCollectionRoleRequest($collection_id, $x_authorization, $x_password, $grant_collection_role_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function grantCollectionRoleRequest($collection_id, $x_authorization, $x_password, $grant_collection_role_request)
    {
        ...
        if ($x_password === null || (is_array($x_password) && count($x_password) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_password when calling grantCollectionRole'
            );
        }
     ...
     * @return \MetaFab\Model\TransactionModel|string|string
     */
    public function revokeCollectionRole($collection_id, $x_authorization, $x_password, $revoke_collection_role_request)
    {
        list($response) = $this->revokeCollectionRoleWithHttpInfo($collection_id, $x_authorization, $x_password, $revoke_collection_role_request);
        return $response;
    }
     ...
     * @return array of \MetaFab\Model\TransactionModel|string|string, HTTP status code, HTTP response headers (array of strings)
     */
    public function revokeCollectionRoleWithHttpInfo($collection_id, $x_authorization, $x_password, $revoke_collection_role_request)
    {
        $request = $this->revokeCollectionRoleRequest($collection_id, $x_authorization, $x_password, $revoke_collection_role_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function revokeCollectionRoleAsync($collection_id, $x_authorization, $x_password, $revoke_collection_role_request)
    {
        return $this->revokeCollectionRoleAsyncWithHttpInfo($collection_id, $x_authorization, $x_password, $revoke_collection_role_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function revokeCollectionRoleAsyncWithHttpInfo($collection_id, $x_authorization, $x_password, $revoke_collection_role_request)
    {
        $returnType = '\MetaFab\Model\TransactionModel';
        $request = $this->revokeCollectionRoleRequest($collection_id, $x_authorization, $x_password, $revoke_collection_role_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function revokeCollectionRoleRequest($collection_id, $x_authorization, $x_password, $revoke_collection_role_request)
    {
        ...
        if ($x_password === null || (is_array($x_password) && count($x_password) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_password when calling revokeCollectionRole'
            );
        }
