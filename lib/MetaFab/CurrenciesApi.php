...
class CurrenciesApi
{
     ...
     * @param  \OpenAPI\Client\Model\BatchTransferCurrencyRequest $batch_transfer_currency_request batch_transfer_currency_request (required)
     *
     ...
     * @param  string $x_authorization The &#x60;secretKey&#x60; of a specific game or the &#x60;accessToken&#x60; of a specific player. (required)
     * @param  string $x_password The password of the authenticating game or player. Required to decrypt and perform blockchain transactions with the game or player primary wallet. (required)
     * @param  \OpenAPI\Client\Model\BatchTransferCurrencyRequest $batch_transfer_currency_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_authorization The &#x60;secretKey&#x60; of a specific game or the &#x60;accessToken&#x60; of a specific player. (required)
     * @param  string $x_password The password of the authenticating game or player. Required to decrypt and perform blockchain transactions with the game or player primary wallet. (required)
     * @param  \OpenAPI\Client\Model\BurnCurrencyRequest $burn_currency_request burn_currency_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\TransactionModel|string|string
     ...
     * @param  string $x_authorization The &#x60;secretKey&#x60; of a specific game or the &#x60;accessToken&#x60; of a specific player. (required)
     * @param  string $x_password The password of the authenticating game or player. Required to decrypt and perform blockchain transactions with the game or player primary wallet. (required)
     * @param  \OpenAPI\Client\Model\BurnCurrencyRequest $burn_currency_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\TransactionModel|string|string, HTTP status code, HTTP response headers (array of strings)
     ...
     * @param  \OpenAPI\Client\Model\CreateCurrencyRequest $create_currency_request create_currency_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CreateCurrency200Response|string|string
     */
     ...
     * @param  string $x_authorization The &#x60;secretKey&#x60; of the authenticating game. (required)
     * @param  string $x_password The password of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet. (required)
     * @param  \OpenAPI\Client\Model\CreateCurrencyRequest $create_currency_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CreateCurrency200Response|string|string, HTTP status code, HTTP response headers (array of strings)
     */
    public function createCurrencyWithHttpInfo($x_authorization, $x_password, $create_currency_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CreateCurrency200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CreateCurrency200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CreateCurrency200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\CreateCurrency200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CreateCurrency200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\GetCurrencies200ResponseInner[]|string
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\GetCurrencies200ResponseInner[]|string, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @return float|string
     */
    public function getCurrencyBalances($currency_id, $address = null, $wallet_id = null)
    {
        list($response) = $this->getCurrencyBalancesWithHttpInfo($currency_id, $address, $wallet_id);
        return $response;
    }

    /**
     * Operation getCurrencyBalancesWithHttpInfo
     *
     * Get currency balance
     *
     * @param  string $currency_id Any currency id within the MetaFab ecosystem. (required)
     ...
     */
    public function getCurrencyBalancesWithHttpInfo($currency_id, $address = null, $wallet_id = null)
    {
        $request = $this->getCurrencyBalancesRequest($currency_id, $address, $wallet_id);
    ...
    /**
     * Operation getCurrencyBalancesAsync
     *
     * Get currency balance
     *
     * @param  string $currency_id Any currency id within the MetaFab ecosystem. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCurrencyBalancesAsync($currency_id, $address = null, $wallet_id = null)
    {
        return $this->getCurrencyBalancesAsyncWithHttpInfo($currency_id, $address, $wallet_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCurrencyBalancesAsyncWithHttpInfo
     *
     * Get currency balance
     *
     * @param  string $currency_id Any currency id within the MetaFab ecosystem. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCurrencyBalancesAsyncWithHttpInfo($currency_id, $address = null, $wallet_id = null)
    {
        $returnType = 'float';
        $request = $this->getCurrencyBalancesRequest($currency_id, $address, $wallet_id);
    ...
    /**
     * Create request for operation 'getCurrencyBalances'
     *
     * @param  string $currency_id Any currency id within the MetaFab ecosystem. (required)
     * @param  string $address A valid EVM based address. For example, &#x60;0x39cb70F972E0EE920088AeF97Dbe5c6251a9c25D&#x60;. (optional)
     * @param  string $wallet_id Any wallet id within the MetaFab ecosystem. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCurrencyBalancesRequest($currency_id, $address = null, $wallet_id = null)
    {

        // verify the required parameter 'currency_id' is set
        if ($currency_id === null || (is_array($currency_id) && count($currency_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $currency_id when calling getCurrencyBalances'
            );
        }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\GetCurrencyFees200Response|string
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\GetCurrencyFees200Response|string, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCurrencyFeesWithHttpInfo($currency_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetCurrencyFees200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\GetCurrencyFees200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetCurrencyFees200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\GetCurrencyFees200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\GetCurrencyFees200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $x_authorization The &#x60;secretKey&#x60; of the authenticating game. (required)
     * @param  string $x_password The password of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet. (required)
     * @param  \OpenAPI\Client\Model\MintCurrencyRequest $mint_currency_request mint_currency_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\TransactionModel|string|string
     ...
     * @param  string $x_authorization The &#x60;secretKey&#x60; of the authenticating game. (required)
     * @param  string $x_password The password of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet. (required)
     * @param  \OpenAPI\Client\Model\MintCurrencyRequest $mint_currency_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\TransactionModel|string|string, HTTP status code, HTTP response headers (array of strings)
     ...
     * @param  string $x_authorization The &#x60;secretKey&#x60; of the authenticating game. (required)
     * @param  string $x_password The password of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet. (required)
     * @param  \OpenAPI\Client\Model\SetCurrencyFeesRequest $set_currency_fees_request set_currency_fees_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\TransactionModel|string|string
     ...
     * @param  string $x_authorization The &#x60;secretKey&#x60; of the authenticating game. (required)
     * @param  string $x_password The password of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet. (required)
     * @param  \OpenAPI\Client\Model\SetCurrencyFeesRequest $set_currency_fees_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\TransactionModel|string|string, HTTP status code, HTTP response headers (array of strings)
     ...
     * @param  string $x_authorization The &#x60;secretKey&#x60; of a specific game or the &#x60;accessToken&#x60; of a specific player. (required)
     * @param  string $x_password The password of the authenticating game or player. Required to decrypt and perform blockchain transactions with the game or player primary wallet. (required)
     * @param  \OpenAPI\Client\Model\TransferCurrencyRequest $transfer_currency_request transfer_currency_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\TransactionModel|string|string
     ...
     * @param  string $x_authorization The &#x60;secretKey&#x60; of a specific game or the &#x60;accessToken&#x60; of a specific player. (required)
     * @param  string $x_password The password of the authenticating game or player. Required to decrypt and perform blockchain transactions with the game or player primary wallet. (required)
     * @param  \OpenAPI\Client\Model\TransferCurrencyRequest $transfer_currency_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\TransactionModel|string|string, HTTP status code, HTTP response headers (array of strings)
